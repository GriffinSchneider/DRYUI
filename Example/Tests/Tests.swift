...
class DRYUISwiftTests: XCTestCase {
    ...
    func testDRYUI() {
        ...
        XCTAssertEqual(v1.backgroundColor, UIColor.redColor())
        ...
        XCTAssertEqual(v2.backgroundColor, UIColor.greenColor())
        ...
        XCTAssertEqual(v3.backgroundColor, UIColor.redColor())
        ...
        XCTAssertEqual(v4.backgroundColor, UIColor.blueColor())
